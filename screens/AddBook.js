...
import {View, Text, TouchableOpacity,Animated, Easing, Image, textInput, StyleSheet, TextInput, StatusBarIOS, TouchableWithoutFeedback } from 'react-native';
        ...
        return(
            <View style = {styles.container}>
                ...
                <TouchableOpacity
                   ...
                   onPress = {
                       () => this.message(this.state.Book, this.state.Authore, this.state.Description, this.state.rating)
                   }>
...
class Star extends React.Component{
    render(){
        return <FontAwesome name= {this.props.filled === true ? "star" : "star-o"} color="blue" size={32}
